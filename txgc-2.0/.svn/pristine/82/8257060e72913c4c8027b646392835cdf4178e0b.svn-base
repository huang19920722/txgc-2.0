...
/**
 * TCyhcWorkerParameter3g entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_cyhc_worker_parameter_3g", catalog = "txgc")
public class WorkerParameter3g implements java.io.Serializable {
	...
	/** default constructor */
	public WorkerParameter3g() {
	}

	/** minimal constructor */
	public WorkerParameter3g(Integer id) {
		this.id = id;
	}
