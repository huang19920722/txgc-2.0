package com.yp.sys.entity.params;
...
/**
 * TCyhcWorkerParameter4g entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_cyhc_worker_parameter_4g")
public class Params4 implements java.io.Serializable {

	// Fields

	/***/
	private static final long serialVersionUID = 1899799169869467769L;
	private Long id;
	...
	/** full constructor */
	public Params4(Long id,
			String wirelessEquipmentManufacturer, String communityScrambler,
			String isCity, String antennaType, String frequencyLoadOne,
			String frequencyLoadTwo, String frequencyLoadThree,
			Integer frequencyLoadNum, String spectrum,
			Double mechanicalUnderAngle, Double electronicUnderAngle,
			Double orientationAngle, Double antennaHangHigh, Double longitude,
			Double latitude, Double altitude, String trafficArea,
			String beautifyWay, String coverType, String coverage,
			String standWay, Timestamp openTime, String supportType,
			String isPublicRru, String isPublicAntenna, String isResist,
			...
			String antennaModel, String tal, String upDownSubframeRatio,
			String specialSubframeRatio, String clusterNum, String enbIp,
			String tac, String mimeName, String sgwName, String stationName,
			String communityName, String totalUnderAngle,
			String antennaManufacturer, Double levelPowerAngle,
			Double verticalPowerAngle, Double inlayUnderAngle,
			String isDoubleFrequencyAntenna, String lac, String ci,
			String antennaGain, Integer searchStarNum,
			Timestamp lastUpdateTime, String surveyType, String gridArea,
			String recentReportedTerminal,
			String electromagneticDisturbIntension, Long orgId,
			Timestamp synchronizationTime, String translateState,
			String signalStrength, String rxqual, String pci, String bcch,
			String rsrq, String bsic, String sinr, String feq,
			Double rollAngle, String rsrp, Integer inCount, Long thresholdId,
			String antennaLength, String isManually, String recordStatus,
			String frequencyPoint, String rssi, String networkMode,
			 String levelDistance, String antennaBarcode,
			String surveyWay, String enb, String cell, String antennaImpedance,
			String polarizationMode, String gain, String levelHalfPowerAngle,
			String verticalHalfPowerAngle, String productionDate) {
		this.id = id;
		...
		this.tal = tal;
		this.upDownSubframeRatio = upDownSubframeRatio;
		this.specialSubframeRatio = specialSubframeRatio;
		this.clusterNum = clusterNum;
		this.enbIp = enbIp;
		this.tac = tac;
		this.mimeName = mimeName;
		this.sgwName = sgwName;
	...
	@Column(name = "orientation_angle", precision = 5, scale = 1)
	...
	@Column(name = "antenna_hang_high", precision = 8)
	...
	@Column(name = "altitude", precision = 8)
	...
	@Column(name = "up_down_subframe_ratio", length = 50)
	public String getUpDownSubframeRatio() {
		return this.upDownSubframeRatio;
	}

	public void setUpDownSubframeRatio(String upDownSubframeRatio) {
		this.upDownSubframeRatio = upDownSubframeRatio;
	}

	@Column(name = "special_subframe_ratio", length = 50)
	public String getSpecialSubframeRatio() {
		return this.specialSubframeRatio;
	}

	public void setSpecialSubframeRatio(String specialSubframeRatio) {
		this.specialSubframeRatio = specialSubframeRatio;
	}

	@Column(name = "cluster_num", length = 50)
	...
	@Column(name = "MIME_name", length = 50)
	...
	@Column(name = "SGW_name", length = 50)
	public String getSgwName() {
		return this.sgwName;
	}

	public void setSgwName(String sgwName) {
		this.sgwName = sgwName;
	}
	...
	@Column(name = "total_under_Angle", length = 50)
	public String getTotalUnderAngle() {
		return this.totalUnderAngle;
	}

	public void setTotalUnderAngle(String totalUnderAngle) {
		this.totalUnderAngle = totalUnderAngle;
	}
	...
	@Column(name = "recent_reported_terminal", length = 50)
	...
	@Column(name = "is_manually", length = 10)
	...
	@Column(name = "frequency_point", length = 50)
	...
	@Column(name = "level_distance", length = 50)
