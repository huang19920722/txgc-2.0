...
<script type="text/javascript" charset="UTF-8">
	...
	$(function(){
			...
			buttons : [ {
				...
				handler : function() {
					if(villageForm.form('validate')){
						...
						var villageUrl="${ctx}/params/vilageAdd3";
						$.ajax({
							url:villageUrl, 
		...
		datagrid = $('#datagrid').datagrid({
			...
			nowrap : false,
			border : false,
			columns:dc.defineColumns('1479284829529'),
			...
			<table>
				...
				<tr>
					<td>
						...
						-->
						<a class="easyui-linkbutton" onclick="dc.showDefineDialog('1479284829529')" href="javascript:void(0);">自定义列</a>
					</td>
				</tr>
			</table>
		</div>
