...
kg/gallery/imgcrop/2.2/type/html5/preview
kg/gallery/imgcrop/2.2/type/html5/selection
kg/gallery/imgcrop/2.2/type/html5/imgcrop
kg/gallery/imgcrop/2.2/type/normal/resizable
kg/gallery/imgcrop/2.2/type/normal/dragable
kg/gallery/imgcrop/2.2/type/normal/imgcrop
kg/gallery/imgcrop/2.2/index
 ...
 * @author 元泉 2013-5-4
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/html5/preview',function (S) {
    var $ = S.all;
    //预览对象
    function Preview() {
 ...
 * @author 元泉 2013-8-17
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/html5/selection',function (S) {
	//选择对象
	function Selection() {
 ...
 * @author 元泉 2013-5-8
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/html5/imgcrop',function (S, Preview, Selection) {
	var $ = S.all;
 ...
 * resize组件
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/normal/resizable',function (S) {
    var Event = S.Event,
        DOM = S.DOM;
    //缩放程序
    function Resize() {
 ...
 *拖拽组件
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/normal/dragable',function (S) {
	var Event = S.Event,
	DOM = S.DOM,
	ie = S.UA.ie;
	//拖放程序
 ...
 * date 2013-3-31
 */
KISSY.add('kg/gallery/imgcrop/2.2/type/normal/imgcrop',function (S, Resize, Drag) {
    var $ = S.all,
        Event = S.Event,
        DOM = S.DOM;
 ...
 * date 2013-5-4
 */
KISSY.add('kg/gallery/imgcrop/2.2/index',function (S, ImgCropCanvas, ImgCropNormal) {
