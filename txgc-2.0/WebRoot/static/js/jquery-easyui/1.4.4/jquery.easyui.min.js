...
var cls="class=\"datagrid-row datagrid-row-even"+(_79a%2&&opts.striped?"datagrid-row-alt ":" ")+_79f+"\"";
if(i%2==0){
	cls="class=\"datagrid-row datagrid-row-odd "+(_79a%2&&opts.striped?"datagrid-row-alt ":" ")+_79f+"\"";
}
